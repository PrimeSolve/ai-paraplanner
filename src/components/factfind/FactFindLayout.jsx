      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        {!sidebarOpen && (
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-r-lg bg-slate-800 text-white flex items-center justify-center hover:bg-slate-700 transition-all"
          >
