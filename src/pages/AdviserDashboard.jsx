      ...
      <div style={{ marginLeft: '260px', flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ padding: '24px 32px', flex: 1 }}>
          ...
          <div style={{ marginBottom: '32px' }}>
            <p style={{ fontSize: '14px', color: '#64748b', marginBottom: '4px' }}>Good evening,</p>
            <h1 style={{ fontSize: '28px', fontWeight: '700', color: '#1e293b', display: 'flex', alignItems: 'center', gap: '12px' }}>
