          ...
          <div className="space-y-6">
                  ...
                  <tbody>
                    <tr className="border-b border-slate-200">
                     ...
                     <tr className="border-b border-slate-200">
                       ...
                       <td className="text-center py-3 px-3"><Input type="number" min="0" max="100" value={formData.allocation?.au_fixed_interest?.target || 0} onChange={(e) => updateAllocation('au_fixed_interest', 'target', e.target.value)} className="h-8 text-center" /></td>
                       <td className="text-center py-3 px-3"><Input type="number" min="0" max="100" value={formData.allocation?.au_fixed_interest?.min || 0} onChange={(e) => updateAllocation('au_fixed_interest', 'min', e.target.value)} className="h-8 text-center" /></td>
                       <td className="text-center py-3 px-3"><Input type="number" min="0" max="100" value={formData.allocation?.au_fixed_interest?.max || 0} onChange={(e) => updateAllocation('au_fixed_interest', 'max', e.target.value)} className="h-8 text-center" /></td>
                     </tr>
                     <tr className="border-b border-slate-200">
                       ...
                       <td className="text-center py-3 px-3"><Input type="number" min="0" max="100" value={formData.allocation?.int_fixed_interest?.target || 0} onChange={(e) => updateAllocation('int_fixed_interest', 'target', e.target.value)} className="h-8 text-center" /></td>
                       <td className="text-center py-3 px-3"><Input type="number" min="0" max="100" value={formData.allocation?.int_fixed_interest?.min || 0} onChange={(e) => updateAllocation('int_fixed_interest', 'min', e.target.value)} className="h-8 text-center" /></td>
                       <td className="text-center py-3 px-3"><Input type="number" min="0" max="100" value={formData.allocation?.int_fixed_interest?.max || 0} onChange={(e) => updateAllocation('int_fixed_interest', 'max', e.target.value)} className="h-8 text-center" /></td>
                     </tr>
                     <tr className="border-b border-slate-200">
                     ...
                     <tr className="border-b border-slate-200">
                       ...
                       <td className="text-center py-3 px-3"><Input type="number" min="0" max="100" value={formData.allocation?.alternatives?.target || 0} onChange={(e) => updateAllocation('alternatives', 'target', e.target.value)} className="h-8 text-center" /></td>
                       <td className="text-center py-3 px-3"><Input type="number" min="0" max="100" value={formData.allocation?.alternatives?.min || 0} onChange={(e) => updateAllocation('alternatives', 'min', e.target.value)} className="h-8 text-center" /></td>
                       <td className="text-center py-3 px-3"><Input type="number" min="0" max="100" value={formData.allocation?.alternatives?.max || 0} onChange={(e) => updateAllocation('alternatives', 'max', e.target.value)} className="h-8 text-center" /></td>
                     </tr>
                     <tr className="border-b border-slate-200">
                       ...
                       <td className="text-center py-3 px-3"><Input type="number" min="0" max="100" value={formData.allocation?.au_equities?.target || 0} onChange={(e) => updateAllocation('au_equities', 'target', e.target.value)} className="h-8 text-center" /></td>
                       <td className="text-center py-3 px-3"><Input type="number" min="0" max="100" value={formData.allocation?.au_equities?.min || 0} onChange={(e) => updateAllocation('au_equities', 'min', e.target.value)} className="h-8 text-center" /></td>
                       <td className="text-center py-3 px-3"><Input type="number" min="0" max="100" value={formData.allocation?.au_equities?.max || 0} onChange={(e) => updateAllocation('au_equities', 'max', e.target.value)} className="h-8 text-center" /></td>
                     </tr>
                     <tr>
            ...
            <div className="flex gap-3 justify-between pt-6 border-t">
             ...
             <div className="flex gap-3 ml-auto">
               ...
               <Button onClick={() => { alert('BUTTON CLICKED'); handleSave(); }} className="bg-blue-600 hover:bg-blue-700 text-white">
                  Save Profile
                </Button>
             </div>
            </div>
