...
import { Search, Users, CheckCircle, Clock, MoreHorizontal, Eye, Edit2, Trash2, TrendingUp, Home, FileText } from 'lucide-react';
                    ...
                    <td className="px-6 py-4">
                      {adviser ? (
                        <div className="flex items-center gap-2">
                          ...
                          >
                            {adviser.first_name?.charAt(0)}{adviser.last_name?.charAt(0)}
                          </div>
                          <div className="min-w-0">
                            <div className="text-sm font-medium text-slate-800 truncate">{adviser.first_name} {adviser.last_name}</div>
