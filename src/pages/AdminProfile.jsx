        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-[#e2e8f0] p-6">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <div className="font-medium text-[#0f172a] mb-1">Email me when new clients are added</div>
                  <div className="text-sm text-[#64748b]">Get notified of new client registrations</div>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="font-medium text-[#0f172a] mb-1">Email me on system alerts</div>
                  <div className="text-sm text-[#64748b]">Get notified of important system events</div>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="font-medium text-[#0f172a] mb-1">Weekly admin summary</div>
                  <div className="text-sm text-[#64748b]">Receive a weekly summary of system activity</div>
                </div>
                <Switch
