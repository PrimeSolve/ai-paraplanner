...
import { Building2, Mail, Calendar, Upload, X } from 'lucide-react';

export default function AdviceGroupProfile() {
  ...
  if (loading) {
    return (
      <AdviceGroupLayout currentPage="AdviceGroupProfile">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-semibold text-[#0f172a] mb-2">
                  {formData.full_name || 'Group Member'}
                </h2>
                <div className="flex items-center gap-4 flex-wrap">
                  <div className="flex items-center gap-1.5 text-sm text-[#8b5cf6]">
                    <Building2 className="w-4 h-4" />
                    <span className="font-medium">Advice Group Manager</span>
                  </div>
          ...
          <div className="bg-white rounded-2xl border border-[#e2e8f0] p-6">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <div className="font-medium text-[#0f172a] mb-1">Email me when new clients are registered</div>
                  <div className="text-sm text-[#64748b]">Get notified of new client signups</div>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="font-medium text-[#0f172a] mb-1">Email me when SOAs are submitted</div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="font-medium text-[#0f172a] mb-1">Daily activity summary</div>
                  <div className="text-sm text-[#64748b]">Receive a daily summary of group activity</div>
                </div>
                <Switch
