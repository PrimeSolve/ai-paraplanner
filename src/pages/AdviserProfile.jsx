...
import { Briefcase, Mail, Calendar, Upload, X } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 flex-wrap">
                  <div className="flex items-center gap-1.5 text-sm text-[#8b5cf6]">
                    ...
                    <span className="font-medium">Financial Adviser</span>
                  </div>
          ...
          <div className="bg-white rounded-2xl border border-[#e2e8f0] p-6">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <div className="font-medium text-[#0f172a] mb-1">Email me when assigned new clients</div>
                  <div className="text-sm text-[#64748b]">Get notified when clients are assigned</div>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="font-medium text-[#0f172a] mb-1">Email me on fact find comments</div>
                  <div className="text-sm text-[#64748b]">Get notified when clients comment on fact finds</div>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="font-medium text-[#0f172a] mb-1">Daily client activity summary</div>
                  <div className="text-sm text-[#64748b]">Receive a daily summary of client activity</div>
                </div>
                <Switch
