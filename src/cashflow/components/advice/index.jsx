...
export function AdviceInsuranceForm({ factFind, updateFF, tab: forcedTab }) {
  ...
  const ic = (value, onChange, placeholder) => (<input type="number" value={value || ""} onChange={e => onChange(e.target.value)} placeholder={placeholder || ""} style={{ width: "100%", maxWidth: 140, padding: "10px 12px", border: "1px solid var(--ps-border)", borderRadius: 8, fontSize: 14, textAlign: "center", background: "var(--ps-surface)", color: "var(--ps-text-body)" }} />);
      ...
      <InsModal show={showIncome} onClose={saveIncomeModal} title={"Edit Income Required — " + cn(person)} wide>
        ...
        {localIR.map((r, i) => (
          <div key={r.id} style={{ display: "grid", gridTemplateColumns: "1fr 120px 100px 120px 80px 100px 36px", gap: 10, padding: "10px 0", alignItems: "center", borderBottom: "1px solid var(--ps-border-light)" }}>
            <select value={r.item} onChange={e => localUIR(i, "item", e.target.value)} style={{ padding: "10px 12px", border: "1px solid var(--ps-border)", borderRadius: 8, fontSize: 14, background: "var(--ps-surface)", color: "var(--ps-text-body)" }}>{INS_INCOME_ITEMS.map(o => <option key={o.value} value={o.value}>{o.label}</option>)}</select>
            ...
            <input type="number" value={r.growth === 0 ? "" : r.growth} onChange={e => localUIR(i, "growth", e.target.value)} placeholder="e.g. 2" style={{ padding: "10px 12px", border: "1px solid var(--ps-border)", borderRadius: 8, fontSize: 14, textAlign: "center", background: "var(--ps-surface)", color: "var(--ps-text-body)" }} />
            <input type="number" value={r.annual_income === 0 ? "" : r.annual_income} onChange={e => localUIR(i, "annual_income", e.target.value)} placeholder="$" style={{ padding: "10px 12px", border: "1px solid var(--ps-border)", borderRadius: 8, fontSize: 14, textAlign: "right", background: "var(--ps-surface)", color: "var(--ps-text-body)" }} />
            <input type="number" value={r.years === 0 ? "" : r.years} onChange={e => localUIR(i, "years", e.target.value)} placeholder="Yrs" style={{ padding: "10px 12px", border: "1px solid var(--ps-border)", borderRadius: 8, fontSize: 14, textAlign: "center", background: "var(--ps-surface)", color: "var(--ps-text-body)" }} />
      ...
      <InsModal show={showAssets} onClose={saveAssetsModal} title={"Less Realised Assets — " + cn(person)} wide>
        ...
        {localAR.map((r, i) => (
          <div key={r.id} style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 36px", gap: 12, padding: "10px 0", alignItems: "center", borderBottom: "1px solid var(--ps-border-light)" }}>
            <input value={r.description || ""} onChange={e => localUAR(i, "description", e.target.value)} placeholder="Describe the asset" style={{ padding: "10px 12px", border: "1px solid var(--ps-border)", borderRadius: 8, fontSize: 14, background: "var(--ps-surface)", color: "var(--ps-text-body)" }} />
            <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
            ...
            <input type="number" value={r.value === 0 ? "" : r.value} onChange={e => localUAR(i, "value", e.target.value)} placeholder="$" style={{ padding: "10px 12px", border: "1px solid var(--ps-border)", borderRadius: 8, fontSize: 14, textAlign: "right", background: "var(--ps-surface)", color: "var(--ps-text-body)" }} />
